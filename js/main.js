...
document.addEventListener('DOMContentLoaded', (event) => {
  ...
  fetchRestaurantsDataAndCacheIt();
});
...
fetchRestaurantsDataAndCacheIt = () => {
	...
	const restaurantData = DBHelper.fetchRestaurants(cacheData);
}
